...
```
### 4.12. [C4 диаграмма концептуальной архитектуры](assets/schemas/arch_schema_c4_container.puml)
![Архитектурная схема](assets/images/arch_schema_c4_container.png) 
[Назад](../README.md)